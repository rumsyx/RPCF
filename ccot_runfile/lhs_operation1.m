function hf_out = lhs_operation1(hf, lambda, eta, filter_sz, samplesf, reg_filter, sample_weights, feature_reg,binary_mask,patch_mask,frame,feature_input,cnna)
