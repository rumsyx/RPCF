...
class BaseConvolutionLayer : public Layer<Dtype> {
 public:
   ...
   float* d_in_response1;
   float2* d_freq_response1;
   float* d_in_response2;
   float2* d_freq_response2;
   float* d_in_response3;
   float2* d_freq_response3;
   float* d_in_response4;
   float2* d_freq_response4;
   float* d_in_response5;
   float2* d_freq_response5;
   ...
   cufftHandle forward_plan_response[5]; 
   cufftHandle inverse_plan_response[5];
